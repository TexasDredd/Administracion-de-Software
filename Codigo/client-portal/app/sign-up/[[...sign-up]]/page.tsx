      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0B2545] relative overflow-hidden flex-col justify-between p-16 text-white">
        ...
        <div className="z-10 max-w-md my-auto space-y-6">
          ...
          <p className="text-slate-300 text-base leading-relaxed">
            Welcome! Sign up to access your event organizer panel. Build detailed layouts, book ballroom chairs, select majestic structure tents, and send logistics workflows immediately to our office team.
          </p>
          <div className="space-y-4 pt-4 text-sm text-slate-300 font-medium">
            <div className="flex items-center gap-3">
              <span className="h-2 w-2 rounded-full bg-blue-500" />
              <span>Full Manifest Inventory Selectors</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="h-2 w-2 rounded-full bg-blue-500" />
              <span>Digital Rental Orders Submitted Instantly</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="h-2 w-2 rounded-full bg-blue-500" />
              <span>Secure, Managed Logistics Tracking</span>
            </div>
          </div>
        </div>
